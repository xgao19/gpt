...
void lattice_init_single_iMSpin4Color2() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSpin4Color2<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSpin4Color2< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iMSpin4Color2<vComplexF>())] = singlet_rank(iMSpin4Color2<vComplexF>());
}