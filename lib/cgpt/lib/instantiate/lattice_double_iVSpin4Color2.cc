...
void lattice_init_double_iVSpin4Color2() {
  ...
  _create_otype_[prec + ":" + get_otype(iVSpin4Color2<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVSpin4Color2< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iVSpin4Color2<vComplexD>())] = singlet_rank(iVSpin4Color2<vComplexD>());
}