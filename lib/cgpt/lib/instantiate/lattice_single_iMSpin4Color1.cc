...
void lattice_init_single_iMSpin4Color1() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSpin4Color1<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSpin4Color1< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iMSpin4Color1<vComplexF>())] = singlet_rank(iMSpin4Color1<vComplexF>());
}