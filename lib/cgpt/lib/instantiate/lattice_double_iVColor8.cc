...
void lattice_init_double_iVColor8() {
  ...
  _create_otype_[prec + ":" + get_otype(iVColor8<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVColor8< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iVColor8<vComplexD>())] = singlet_rank(iVColor8<vComplexD>());
}