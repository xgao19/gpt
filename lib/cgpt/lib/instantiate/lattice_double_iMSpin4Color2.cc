...
void lattice_init_double_iMSpin4Color2() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSpin4Color2<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSpin4Color2< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iMSpin4Color2<vComplexD>())] = singlet_rank(iMSpin4Color2<vComplexD>());
}