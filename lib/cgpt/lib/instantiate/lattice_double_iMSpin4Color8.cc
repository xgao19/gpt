...
void lattice_init_double_iMSpin4Color8() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSpin4Color8<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSpin4Color8< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iMSpin4Color8<vComplexD>())] = singlet_rank(iMSpin4Color8<vComplexD>());
}