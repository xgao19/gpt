...
void lattice_init_single_iVSinglet30() {
  ...
  _create_otype_[prec + ":" + get_otype(iVSinglet30<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVSinglet30< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVSinglet30<vComplexF>())] = singlet_rank(iVSinglet30<vComplexF>());
}