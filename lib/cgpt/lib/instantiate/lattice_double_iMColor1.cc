...
void lattice_init_double_iMColor1() {
  ...
  _create_otype_[prec + ":" + get_otype(iMColor1<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMColor1< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iMColor1<vComplexD>())] = singlet_rank(iMColor1<vComplexD>());
}