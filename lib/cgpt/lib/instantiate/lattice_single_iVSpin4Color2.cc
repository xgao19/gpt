...
void lattice_init_single_iVSpin4Color2() {
  ...
  _create_otype_[prec + ":" + get_otype(iVSpin4Color2<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVSpin4Color2< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVSpin4Color2<vComplexF>())] = singlet_rank(iVSpin4Color2<vComplexF>());
}