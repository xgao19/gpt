...
void lattice_init_single_iMColor3() {
  ...
  _create_otype_[prec + ":" + get_otype(iMColor3<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMColor3< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iMColor3<vComplexF>())] = singlet_rank(iMColor3<vComplexF>());
}