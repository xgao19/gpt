...
void lattice_init_single_iVColor8() {
  ...
  _create_otype_[prec + ":" + get_otype(iVColor8<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVColor8< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVColor8<vComplexF>())] = singlet_rank(iVColor8<vComplexF>());
}