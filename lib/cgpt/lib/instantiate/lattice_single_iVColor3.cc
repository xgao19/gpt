...
void lattice_init_single_iVColor3() {
  ...
  _create_otype_[prec + ":" + get_otype(iVColor3<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVColor3< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVColor3<vComplexF>())] = singlet_rank(iVColor3<vComplexF>());
}