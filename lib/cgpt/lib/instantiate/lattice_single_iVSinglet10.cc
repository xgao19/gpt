...
void lattice_init_single_iVSinglet10() {
  ...
  _create_otype_[prec + ":" + get_otype(iVSinglet10<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVSinglet10< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVSinglet10<vComplexF>())] = singlet_rank(iVSinglet10<vComplexF>());
}