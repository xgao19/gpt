...
void lattice_init_double_iVColor1() {
  ...
  _create_otype_[prec + ":" + get_otype(iVColor1<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVColor1< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iVColor1<vComplexD>())] = singlet_rank(iVColor1<vComplexD>());
}