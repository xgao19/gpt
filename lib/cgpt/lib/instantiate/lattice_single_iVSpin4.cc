...
void lattice_init_single_iVSpin4() {
  ...
  _create_otype_[prec + ":" + get_otype(iVSpin4<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVSpin4< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVSpin4<vComplexF>())] = singlet_rank(iVSpin4<vComplexF>());
}