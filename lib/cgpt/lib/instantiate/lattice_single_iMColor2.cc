...
void lattice_init_single_iMColor2() {
  ...
  _create_otype_[prec + ":" + get_otype(iMColor2<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMColor2< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iMColor2<vComplexF>())] = singlet_rank(iMColor2<vComplexF>());
}