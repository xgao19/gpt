...
void lattice_init_single_iVColor1() {
  ...
  _create_otype_[prec + ":" + get_otype(iVColor1<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVColor1< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVColor1<vComplexF>())] = singlet_rank(iVColor1<vComplexF>());
}