...
void lattice_init_single_iVSinglet4() {
  ...
  _create_otype_[prec + ":" + get_otype(iVSinglet4<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iVSinglet4< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iVSinglet4<vComplexF>())] = singlet_rank(iVSinglet4<vComplexF>());
}