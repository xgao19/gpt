...
void lattice_init_double_iMSpin4() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSpin4<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSpin4< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iMSpin4<vComplexD>())] = singlet_rank(iMSpin4<vComplexD>());
}