...
void lattice_init_double_iMColor3() {
  ...
  _create_otype_[prec + ":" + get_otype(iMColor3<vComplexD>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMColor3< vComplexD > >(grid); };
  _otype_singlet_rank_[get_otype(iMColor3<vComplexD>())] = singlet_rank(iMColor3<vComplexD>());
}