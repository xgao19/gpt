...
void lattice_init_single_iMSinglet10() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSinglet10<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSinglet10< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iMSinglet10<vComplexF>())] = singlet_rank(iMSinglet10<vComplexF>());
}