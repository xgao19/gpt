...
void lattice_init_single_iMSinglet4() {
  ...
  _create_otype_[prec + ":" + get_otype(iMSinglet4<vComplexF>())] = [](GridBase* grid) { return (void*)new cgpt_Lattice< iMSinglet4< vComplexF > >(grid); };
  _otype_singlet_rank_[get_otype(iMSinglet4<vComplexF>())] = singlet_rank(iMSinglet4<vComplexF>());
}